...
import cv2
import os
train_list = glob.glob("./pytorch入门到进阶/home/dataset/cifar-10-batches-py/data_batch_*")
# print(train_list)
save_path = "./pytorch入门到进阶/home/dataset/cifar-10-batches-py/test"
# save_path = "./pytorch入门到进阶/home/dataset/cifar-10-batches-py/train"
...
for l in train_list:
    ...
    for im_idx, im_data in enumerate(l_dict[b'data']):
        ...
        # 把原来的第0个维度放在最后面，变成最后一个维度
        im_data = np.transpose(im_data, (1, 2, 0))

        # cv2.resize 重新设定了图片大小
        cv2.imshow("im_data",cv2.resize(im_data, (200, 200)))
        # cv2.waitKey(0) # waitKey 需要回车键才会出现下一张图
