...
const generateGalaxy = () => {
  ...
  geometry.setAttribute("color", new THREE.BufferAttribute(colors, 3)); // （warn：修改！！！！）

  //   设置点材质
  material = new THREE.PointsMaterial({
    // color: new THREE.Color(params.color), （warn：修改！！！！）
    size: params.size,
